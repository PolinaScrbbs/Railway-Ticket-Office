...
Revision ID: e00347759ee3
Revises: 
Create Date: 2024-06-10 18:22:31.404149
...
def upgrade() -> None:
    ...
    sa.Column('number', sa.VARCHAR(length=2), nullable=False),
    ...
    sa.Column('number', sa.VARCHAR(length=3), nullable=False),
